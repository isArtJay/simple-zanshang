...
ZanShang.prototype._init = function(){
  ...
  this.zsbtn.each(function(el){
    $(this).on('click',function(){
      ...
      /*
        你可以自定义这个图片的路径，默认放在当前images目录中
        假如你加的是远程路径（就是图片在服务器上），那么就将下边一行代码替换掉，比如我的是:
        var src = 'https://artjay-1258580758.cos.ap-shanghai.myqcloud.com/Zanshang/pay/'+type+'-'+num+'.png';
      */
      var src = './images/'+type+'-'+num+'.png'; //图片路径
      var text = $(this).html();
